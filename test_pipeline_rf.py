...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Proctoring Tracking Pipeline CLI (Random Forest & Early Recording) and Dependency Checker")
    ...
    from main_orchestrator_rf import MainOrchestrator
    
    print(f"\nStarting RandomForest-based Proctoring System...")

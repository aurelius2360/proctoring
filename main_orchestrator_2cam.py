...
class MainOrchestrator:
    def __init__(self, camera_index=0, video_path=None, baseline_photo_path=None):
        ...
        self.gaze_history = deque(maxlen=1800)  # Up to 60 seconds of history at 30 FPS
        
        # Thread-safe Queues with larger buffers for delayed/high-FPS batching
        self.gaze_queue = queue.Queue(maxsize=1800)
        self.object_queue = queue.Queue(maxsize=300)
        ...
        self.sequence_worker = SequenceWorker(self.sequence_queue, self.decision_queue)

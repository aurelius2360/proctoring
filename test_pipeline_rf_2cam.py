...
def check_dependencies():
    print("=" * 50)
    print("Checking Proctoring Pipeline (Dual Camera) Dependencies...")
    print("=" * 50)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Proctoring Tracking Pipeline CLI (Dual Camera & Random Forest) and Dependency Checker")
    ...
    from main_orchestrator_rf_2cam import MainOrchestrator
    
    print(f"\nStarting Dual Camera & RandomForest-based Proctoring System...")
